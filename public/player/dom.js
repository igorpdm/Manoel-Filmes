export const dom = {
    ...
    uploadResumeHint: document.getElementById('upload-resume-hint'),
    uploadResumeFilename: document.getElementById('upload-resume-filename'),
    uploadResumeProgress: document.getElementById('upload-resume-progress'),
    ...
    ratingsModalTitle: document.getElementById('ratings-modal-title'),
    ratingsSummary: document.getElementById('ratings-summary'),
    ratingsDeadline: document.getElementById('ratings-deadline'),
